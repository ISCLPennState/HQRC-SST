...
class hqrc(object):
    ...
    def __feed_forward(self, input_sequence, predict, use_lastrho):
        ...
        if predict:
            ...
            predict_sequence = stacked_state @ W_out ####
    ...
    def train(self):
        ...
        sparse_input_train = self.scaler.scaleData(sparse_input_train,reuse=1)
    ...
    def predictSequence(self, input_sequence, sparse_input):
        ...
        if True:
            ...
            for t in range(it_pred_length):
                ...
                sparse_state = np.array(sparse_input[t],dtype=np.float64).reshape(1,-1)
    ...
    def predictIndexes(self, input_sequence, ic_indexes, sparse_input, dt, set_name):
        ...
        for ic_num in range(n_tests):###
            ...
            sparse_input_ic = sparse_input[ic_idx:ic_idx+self.it_pred_length]
